...
/*
 * Came with something I borrowed from who-knows-where. Not all of these be needed, double check with Ari before deploying
 */
...
public abstract class RobotConfig {
   ...
   */
  public abstract frc.robot.configs.SwerveConstants.SwerveType getSwerveType();
